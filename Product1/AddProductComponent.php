...
class AddProductComponent extends Component
{
    ...
    public $scategory_id;public $idIn;
    ...
    public function updated($fields)
    {
        $this->validateOnly($fields,[
            ...
            'originalPrice'=>'required|numeric', 'sellingPrice'=>'required|numeric','quantity'=>'required|numeric','metaTitle'=>'required','metaKeyword'=>'required',
...
//        dd('hi');
        ...
        $imagesname='';
        $data=[
            'product_id'=>$this->product_id, 'category_id'=>$this->category_id, 'BrandId'=>$this->BrandId, 'colorId'=>$this->colorId,
            'shortDescription'=>$this->shortDescription, 'longDescription'=>$this->longDescription, 'originalPrice'=>$this->originalPrice,
            'sellingPrice'=>$this->sellingPrice, 'quantity'=>$this->quantity, 'trending'=>$this->trending, 'active'=>$this->active,
