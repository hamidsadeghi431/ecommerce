        ...
        <div class="card card-primary card-outline">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <button wire:click="quantity({{$idIn}})" type="button" class="btn btn-warning" data-dismiss="modal" aria-label="Close">
...
{{--                                <td class="text-center">{{$item->colors_name->colorName}}</td>--}}
                                <td class="text-center">{{\App\Models\colors::where('id',$item->colors_id)->value('colorName')}}</td>
                                <td class="text-center">{{$item->size_name->sizeName}}</td>
{{--                                <td class="text-center">{{$item->size_details_name->title}}</td>--}}
                                <td class="text-center">{{\App\Models\sizedetails::where('id',$item->sizedetails_id)->value('title')}}</td>
