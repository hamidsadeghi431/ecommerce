    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @livewire('admin.product.add-product-component')
            </div>
...
<div class="modal fade" id="add_qty">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">افزودن محصول</h4>
            ...
            <div class="modal-body">
                @livewire('admin.product.add-qty-product-component')
            </div>
...
<div class="modal fade" id="show_qty">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">جدول موجودی محصولات</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                @livewire('admin.product.show-qty-product-component')
            </div>
