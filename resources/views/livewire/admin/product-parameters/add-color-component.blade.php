    ...
    <div class="card card-primary">
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input wire:model="colorName" class="form-control" id="exampleInputEmail1" placeholder="نام ویژگی">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">کد رنگ</label>
                    <input wire:model="colorCode" class="form-control" id="exampleInputEmail1" placeholder="نام ویژگی">
